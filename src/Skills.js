        ...
        return(
            <Container id="skills">
                    ...
                    <div className="skillset">
                        <Skill name="Javascript/Typescript" sub=" (React, Express, Node, Redux, jQuery)" proficiency="Proficient" level={90}/>
                        <Skill name="Java" proficiency="Proficient" level={85}/>
                        <Skill name="Python" proficiency="Proficient" level={85}/>
                        <Skill name="Databases" sub=" (BigQuery, PostgreSQL, MongoDB)" proficiency="Proficient" level={80}/>
